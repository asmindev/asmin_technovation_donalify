<!-- ========== HEADER ========== -->
<header class="px-4 md:px-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7">
    <nav class="border border-lime-300 rounded-3xl bg-lime-50 py-2 relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-8 mx-auto" aria-label="Global">
