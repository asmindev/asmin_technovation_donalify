<footer class="mt-auto w-full  py-10 px-4 sm:px-6 lg:px-8 mx-auto border-t">
    <div class="text-center">
        <div>
            <a class="flex-none text-xl font-semibold text-black dark:text-white" href="/" aria-label="Brand">Donalify</a>
        </div>
